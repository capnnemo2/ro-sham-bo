...
export default class Choices extends React.Component {
  ...
  chooseRock = () => {
    this.context.makeChoice("rock");
  };

  choosePaper = () => {
    this.context.makeChoice("paper");
  };

  chooseScissors = () => {
    this.context.makeChoice("scissors");
  };
      ...
      <div className="Choices">
        <div className="content">
          <div className="triangle">
            ...
            <div className="hand rock-choice">
            ...
            <div className="hand paper-choice">
            ...
            <div className="hand scissors-choice">
